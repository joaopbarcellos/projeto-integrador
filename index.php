	...
	<header>
		...
		if (isset($_POST['pesquisar'])){
			...
			<div id='filtros'>
				...
				<form id="containerteladrag" action="conexaoBancoDados/filtrar.php" method="post">
					<div class="teladrag">
						<button class="filtroesporte" type="submit" value="Futebol" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Basquete" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte" type="submit" value ="Atletismo" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Natação" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Vôlei" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte" type="submit" value ="Xadrez" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte" type="submit" value ="Skate" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Tênis" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Surfe" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Ciclismo" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Handebol" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value="Tênis de Mesa" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512">
						...
						<button class="filtroesporte" type="submit" value="Motocross" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Mountain Bike" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Futebol Americano" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte" type="submit" value ="Hipismo" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Boxe" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Capoeira" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Judô" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Canoagem" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte" type="submit" value ="Polo Aquático" name="esporte">
							<div class="alinhafiltro">
