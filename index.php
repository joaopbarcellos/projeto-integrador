...
<body>
	...
	<header>
		...
		<form action="conexaoBancoDados/filtrar.php" method="post">
			<div class="owl-carousel filtro">
				<div class ='item filtroesporte' value="Futebol" type="submit" name="esporte">
				...
				<div class ='item filtroesporte' value ="Basquete" type="submit" name="esporte">
					<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
				...
				<div class ='item filtroesporte' value ="Atletismo" type="submit" name="esporte">
				...
				<div class ='item filtroesporte' value ="Natação" type="submit" name="esporte">
				...
				<div class ='item filtroesporte' value ="Vôlei" type="submit" name="esporte">
					<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
				...
				<div class ='item filtroesporte' value ="Xadrez" type="submit" name="esporte">
					<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
				...
				<div class ='item filtroesporte' value ="Skate" type="submit" name="esporte">
					<img src="img/skate.png">
				</div>

				<div class ='item filtroesporte' value ="Tênis" type="submit" name="esporte">
					<img src="img/tennis.png">
				</div>

				<div class ='item filtroesporte' value ="Surfe" type="submit" name="esporte">
					<img src="img/surf.png">
				</div>

				<div class ='item filtroesporte' value ="Ciclismo" type="submit" name="esporte">
				...
				<div class ='item filtroesporte' value ="Handebol" type="submit" name="esporte">
					<img src="img/handball.png">
				</div>

				<div class ='item filtroesporte' value ="Tênis de Mesa" type="submit" name="esporte">
					<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512">
				...
				<div class ='item filtroesporte' value ="Motocross" type="submit" name="esporte">
					<img src="img/capacete.png">
				</div>

				<div class ='item filtroesporte' value ="Mountain Bike" type="submit" name="esporte">
					<img src="img/mountain.png">
				</div>

				<div class ='item filtroesporte' value ="Futebol Americano" type="submit" name="esporte">
					<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
				...
				<div class ='item filtroesporte' value ="Hipismo" type="submit" name="esporte">
					<img src="img/hipismo.png">
				</div>

				<div class ='item filtroesporte' value ="Boxe" type="submit" name="esporte">
					<img src="img/boxe.png">
				</div>

				<div class ='item filtroesporte' value ="Capoeira" type="submit" name="esporte">
					<img src="img/capoeira.png">
				</div>

				<div class ='item filtroesporte' value ="Judô" type="submit" name="esporte">
					<img src="img/judo.png">
				</div>

				<div class ='item filtroesporte' value ="Canoagem" type="submit" name="esporte">
					<img src="img/canoagem.png">
				</div>

				<div class ='item filtroesporte' value ="Polo Aquático" type="submit" name="esporte">
