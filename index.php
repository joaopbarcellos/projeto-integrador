			...
			<div id='filtros'>
				...
				<form class="carouselContainer" action="conexaoBancoDados/filtrar_esporte.php" method="post">
					<div class="carouselOfImages">
						<button class="filtroesporte carouselimage" type="submit" value="Futebol" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Basquete" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Atletismo" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Natação" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Vôlei" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Xadrez" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Skate" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Tênis" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Surfe" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Ciclismo" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Handebol" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value="Tênis de Mesa" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512">
						...
						<button class="filtroesporte carouselimage" type="submit" value="Motocross" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Mountain Bike" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Futebol Americano" name="esporte">
							<div class="alinhafiltro">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Hipismo" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Boxe" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Capoeira" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Judô" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Canoagem" name="esporte">
							<div class="alinhafiltro">
						...
						<button class="filtroesporte carouselimage" type="submit" value ="Polo Aquático" name="esporte">
							<div class="alinhafiltro">
