...
<head>
	...
	<link rel="stylesheet" href="css/styles_myevents.css">

	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet"
		integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">

	<script src="js/script_meuseventos.js" type="module"></script>
...
<body>
					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown">
							<a class="links nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
								aria-expanded="false">
								<svg class="iconeconfig" xmlns="http://www.w3.org/2000/svg" height="1em"
									viewBox="0 0 512 512">
									<path
							...
							<!-- Lista com os links dos dropdown -->
							<ul class="dropdown-menu">
								...
								</li> <!-- Fechando lista com os link -->

							</ul> <!--Fechando lista geral com o dropdown  -->
	...
	<h1 class="fs-1">Meus Eventos</h1>
	<p class="text-center" id="semevento">Você não possui eventos inscritos!</p>
