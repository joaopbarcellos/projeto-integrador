...
<head>
	...
	<link rel="stylesheet" href="css/styles_alterarSenha.css">

	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet"
		integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">

	<script src="js/script_alterarSenha.js" type="module" defer></script>
				...
				<div id="senhas">
					...
					<div class="campos senhaAntiga mb-4">
						...
						<div class="form-floating">
							...
							<input type="password" class="form-control" id="floatingInputGroup1"
								placeholder="Senha antiga" name="senhaAntiCampo">
					...
					<div class="campos senha mb-4">
						...
						<div class="form-floating">
							...
							<input type="password" class="form-control" id="floatingInputGroup2"
								placeholder="Senha nova" name="senhaCampo">
					...
					<div class="campos confirmSenha mb-4">
						...
						<div class="form-floating">
							...
							<input type="password" class="form-control" id="floatingInputGroup3"
								placeholder="Confirmar Senha" name="confSenhaCampo">
