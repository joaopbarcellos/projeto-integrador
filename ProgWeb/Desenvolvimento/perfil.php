...
<head>
	...
	<script src="js/script_perfil.js" type="module" defer></script>
...
<body>
	...
	<div id="container">
		<div class="col-10 col-md-6 col-lg-5 col-xg-3 col-xxl-4" id="alinhar">
			...
			<div id="botoes"> 
				<button id="editar"><svg class="iconeeditar" xmlns="http://www.w3.org/2000/svg" height="1em"
						viewBox="0 0 512 512">
						<path
				...
				<button id="excluir"><svg class="iconeexcluir" xmlns="http://www.w3.org/2000/svg" height="1em"
						viewBox="0 0 448 512">
						<path
