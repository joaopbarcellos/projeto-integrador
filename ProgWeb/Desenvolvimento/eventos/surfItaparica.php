...
<body>
	...
	<div id="container" class="container col-12 m-auto">
		...
		<!-- Adicionando titulo -->
		<h1 id="titulo" class="text-center text-lg-start offset-1">Surf - Praia de Itaparica</h1>
		<div id="evento" class="row">

			<div id="tabela" class="col-12 col-lg-10 m-auto">
				<img src="../img/12.png" id="img_evento">
			</div>
			...
			<div id="informacoes" class="col-12 col-lg-10 m-auto">
				...
				<div id="desc">
					<p id="t_desc" class="fs-3" class="fs-3" class="fs-3"><b>Descrição</b></p>
					<p id="p_desc">
						Surf na cidade de Vila Velha - ES na Praia de Itaparica
					</p>
				</div>
				...
				<div class="vagas">
					<div id="vagas_restam">
						<p id="t_vagasrestam"><b>Vagas restantes: </b>4</p>
					</div>

					<!-- Div com o numero de inscritos do evento -->
					<div id="num_inscritos">
						<p id="t_numinscritos"><b>Número de Inscritos: </b>6</p>
					</div>
				</div>
