...
<head>
	...
	<script src="js/script_home.js" type="module" defer></script>
...
<li class="nav-item dropdown">
	...
	<div id="carouselExampleInterval" class="carousel slide d-none d-sm-block col-11 col-md-10 col-lg-8 col-xg-6 m-auto"
