  ...
  <div class="div_cadastro mt-5 col-lg-4 col-10 m-auto">
    <div>
      <a href="login.php" id="voltar">
        <svg class="img_voltar" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
      ...
      <form method="post" action="conexaoBancoDados/registrar.php"> 
        ...
        <div class="nome campos">
          ...
          <div class="form-floating fs-5">
            <input type="text" class="form-control" id="floatingInputGroup1" placeholder="Nome" name="nomeCampo" tabindex="1" />
        ...
        <div class="email campos">
          ...
          <div class="form-floating fs-5">
            <input type="email" class="form-control" id="floatingInputGroup2" placeholder="E-mail" name="emailCampo" tabindex="2" />
        ...
        <?php
          if (isset($_GET['nome'])) {
            ...
            campoNome.value = `' . $_GET["nome"] .'`;
            campoData.value = `' . $_GET["data"] . '`;
            campoTelefone.value = `' . $_GET["telefone"] . '`;
        ...
        <div class="senha campos">
          ...
          <div class="form-floating fs-5">
            ...
            <input type="password" class="form-control" id="floatingInputGroup3" placeholder="Senha" name="senhaCampo" tabindex="4" />
          ...
          <label class="erro" id="aotPass">Senha deve ter 6 a 30 caracteres!</label>
        </div>
        ...
        <div class="confir_senha campos fs-5">
          ...
          <div class="form-floating">
            ...
            <input type="password" class="form-control" id="floatingInputGroup4" placeholder="Confirmação de senha" name="confsenhaCampo" tabindex="5" />
