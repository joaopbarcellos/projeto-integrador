...
<body>
	...
	<div id="container" class="container col-12 m-auto">
		...
		<!-- Adicionando titulo -->
		<h1 id="titulo" class="text-center text-lg-start offset-1">Mar Dourado Beach Tennis</h1>
		<div id="evento" class="row">

			<div id="tabela" class="col-12 col-lg-10 m-auto">
				<img src="../img/11.png" id="img_evento">
			</div>
			...
			<div id="informacoes" class="col-12 col-lg-10 m-auto">
				...
				<div id="desc">
					...
					<p id="p_desc">
						Este é um projeto da Prefeitura de Vila Velha junto com o Point Mar Dourado de Beach Tennis,
						para inserir a modalidade nos esportes educacionais ofertados nas escolas futuramente
					</p>
				</div>
				...
				<div class="vagas">
					<div id="vagas_restam">
						<p id="t_vagasrestam"><b>Vagas restantes: </b>40</p>
					</div>

					<!-- Div com o numero de inscritos do evento -->
					<div id="num_inscritos">
						<p id="t_numinscritos"><b>Número de Inscritos: </b>10</p>
					</div>
				</div>
