...
<body>
	...
	<div id="container" class="container col-12 m-auto mt-4">
		<div id="fundoev" class="col-11 col-md-8  col m-auto">
			<!-- Adicionando titulo -->
			<h1 id="titulo" class="text-center">L'Étape Rio de Janeiro</h1>
			<div id="evento" class="row">

				<div id="tabela">
					<img src="../img/8.png" id="img_evento">
				</div>
				...
				<div id="informacoes">
					...
					<div id="desc">
						...
						<p id="p_desc">
							O L’ÉTAPE RIO DE JANEIRO SANTANDER é um evento de ciclismo amador,
							cujo objetivo é aproximar os participantes da experiência da maior competição
					...
					<div id="alvo">
						<p id="publi"><b>Faixa Etária: </b>Acima de 18 anos</p>
					</div>
					...
					<div class="vagas">
						<div id="vagas_restam">
							<p id="t_vagasrestam"><b>Vagas restantes: </b> 202</p>
						</div>

						<!-- Div com o numero de inscritos do evento -->
						<div id="num_inscritos">
							<p id="t_numinscritos"><b>Número de Inscritos: </b> 1298</p>
						</div>
					</div>
