...
<body>
	...
	<div id="container" class="container col-12 m-auto mt-4">
		<div id="fundoev" class="col-11 col-md-8  col m-auto">
			<!-- Adicionando titulo -->
			<h1 id="titulo" class="text-center">10ª corrida da penha</h1>
			<div id="evento" class="row">

				<div id="tabela">
					<img src="../img/9.png" id="img_evento">
				</div>
				...
				<div id="informacoes">
					...
					<div id="desc">
						...
						<p id="p_desc">
							O percurso será da Praça dos Ciclista à Prainha. Os participantes passarão pelas avenidas
							Estudante José Júlio de Souza e Gil Veloso, além das ruas Castelo Branco e Antônio Ataíde.
							Durante o trajeto, uma das faixas das vias será interditada para passagem dos atletas. A Guarda
							Municipal dará apoio com batedores da motopatrulha e viaturas no deslocamento.
						</p>
					</div>
					...
					<div id="alvo">
						<p id="publi"><b>Faixa Etária: </b> Acima de 6 anos</p>
						<p></p>
					</div>

					<!-- Div com o intuito do evento -->
					<div id="intuito">
						<p id="sifrao"><b>Público alvo: </b> Para profissionais</p>
					</div>

					<!-- Div com o numero de vagas restantes -->
					<div class="vagas">
						<div id="vagas_restam">
							<p id="t_vagasrestam"><b>Vagas restantes: </b> 174</p>
						</div>

						<!-- Div com o numero de inscritos do evento -->
						<div id="num_inscritos">
							<p id="t_numinscritos"><b>Número de Inscritos: </b> 326</p>
						</div>
					</div>
					...
					<button class="inscrever fixo" id="corridaPenha">
