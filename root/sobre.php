		...
		<div class="row">
			<div class="col-12">
				<div class="video-container">
					<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/EHcIMmAS14Y" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="participante col-12 col-sm-6 col-md-4 col-lg-3">
				...
				<div class="pessoas">
					...
					<span class="span_integrantes">
						...
						<svg class="iconeSobre" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
						...
						<a href="https://www.instagram.com/fellipy_wagmacker/" target="_blank" id="textos">fellipy_wagmacker</a>
			...
			<div class="participante col-12 col-sm-6 col-md-4 col-lg-3">
				...
				<div class="pessoas">
					...
					<span class="span_integrantes">
						...
						<a href="https://www.instagram.com/gustavo.alcaetano/" target="_blank" id="textos">gustavo.alcaetano</a>
