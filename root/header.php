...
<body>
	...
	<nav class="navbar navbar-expand-lg header ">
		<div class="container-fluid col-11 m-auto">
			<a class="navbar-brand" href="<?php echo $rootDir . '/home.php'; ?>"><img src="<?php echo $rootDir . '/logos/9.png'; ?>" id="logo"></a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<?php
					...
					if ($currentPage === 'home.php' || $currentPage === 'myevents.php') {
				...
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item nav-link">
						<a href="<?php echo $rootDir . '/home.php'; ?>" id="homea">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
							...
							<!-- Segundo link -->
							<li>
								<a class="dropdown-item" href="<?php echo $rootDir . '/ajuda.php'; ?>" id="ajudaa">
