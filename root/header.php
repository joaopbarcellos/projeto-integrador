				...
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item nav-link">
						<a href="<?php echo $rootDir . '/index.php'; ?>" id="homea">
							<svg class="iconecasinha" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
					...
					<li class="nav-item nav-link">
						<a href="<?php echo $rootDir . '/criaEvento.php'; ?>" id="criaa">
							<svg class="iconecria" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
					...
					<li class="nav-item nav-link">
						<a href="<?php echo $rootDir . '/myevents.php'; ?>" id="myeventsa">
							<svg class="iconemeusevents" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
					...
					<li class="nav-item nav-link">
						<a href="<?php echo $rootDir . '/sobre.php'; ?>" id="sobrea">
							<svg class="iconesobre" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
					...
					<li class="nav-item nav-link">
						<a href="<?php echo $rootDir . '/ajuda.php'; ?>" id="ajudaa">
							<svg class="iconeajuda" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
