...
function carregar_endereco($db_con, $id_endereco){
    ...
    $descricao = explode(",", $linha_endereco["descricao"]);
    if ($descricao[1]){
        return  $descricao[0] . ", " . $linha_endereco["numero"] . ", " . $descricao[1] . " - " . $linha_bairro["nome"] . ", " . $linha_cidade["nome"] . " - " . $linha_estado["nome"] . ", " . $linha_endereco["cep"];
    }
    return  $descricao[0] . ", " . $linha_endereco["numero"] . " - " . $linha_bairro["nome"] . ", " . $linha_cidade["nome"] . " - " . $linha_estado["nome"] . ", " . $linha_endereco["cep"];
    }
?>
