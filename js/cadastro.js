...
function verificaTudo() {
  ...
  if (verificaNome) verificaNome = base.validarSeNomeTemNumero(campoNome.value, false, campoNome, labelNome);
  if (verificaNome) verificaNome = base.validarSeNomeTemCaracterEspecial(campoNome.value, false, campoNome, labelNome);
